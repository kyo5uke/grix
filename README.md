...
約90秒)。無変更時の更新は約2.4秒で、ファイル内容は一切再読しません。

Windows はディレクトリ走査が高コストなので、Linux(GitHub Actions の
素のランナー、4コア — [公開ログ](https://github.com/kyo5uke/grix/actions/runs/27286573555))
だと差は縮まりますが、それでも決定的です:
